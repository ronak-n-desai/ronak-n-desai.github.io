...
Additionally, I also compared the heating estimates to compare the slope determined by eq. \eqref{eq:arberformula}. As an example, I have a graph displayed below that shows the heating of both the electrons and protons in the simulation. 
