...
where $\alpha_H$ is an empirically derived factor that depends on both the shape function and presence of current smoothing. Also, $n_{23}$ is the number density in units of {% raw %} $10^{23} \frac{1}{\text{cm}^3} {% endraw %}
...
<img src="/osunotebook/research/images/heating_r=0.5.png" style="width: 45%;"/> <img src="/osunotebook/research/images/heating_r=0.5_1D.png" style="width: 45%;"/>
