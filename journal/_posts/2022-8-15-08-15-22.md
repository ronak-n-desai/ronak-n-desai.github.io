...
\begin{equation}
\tau_H \sim \frac{n_{ppc}}{\omegea_{pe}} ( \lambda_D / \Delta x)^2
\end{equation}
...
\begin{equation}
\tau_H \sim \frac{n_{ppc}}{\omegea_{pe}} ( \lambda_D / \Delta x)
\end{equation}

if we now solve for $\frac{dT}{dt}$, the temperature dependence of $T_0$ does not cancel out:

\begin{equation}
\frac{dT}{dt} \propto \frac{n_23 \Delta x \sqrt{T_0}}{n_{ppc}}
\end{equation}

Using the same parameters from the plot I made last week, I used this modified formula
