...
Seems that when The Debye Length is close to the cell size, the initial temperature does not matter too much. However, when the Debye Length is severely under-resolved 
