...
in my code, I clip the quantity under the arccos to be a minimum of 0 and maximum of 1 so that we don't get an invalid value in the argument of the arccos
