...
Here we see that the {\textrm{\color{red} simulation field energy}} is slightly lower than the {\textrm{\color{gray} theoretical energy}} in the laser pulse shown in the dashed line. This is to be expected as some of the energy should transfer to the protons and electrons. In the next plot, I take the theoretical energy and subtract off the energy in protons and electrons to get an estimate of the energy that should be left in the pulse
