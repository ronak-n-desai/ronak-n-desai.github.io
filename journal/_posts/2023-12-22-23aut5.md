...
Here we see that the {\textrm{\color{red} simulation field energy}} is slightly lower than the {\color{gray} theoretical energy} in the laser pulse shown in the dashed line. This is to be expected as some of the energy should transfer to the protons and electrons. In the next plot, I take this th
