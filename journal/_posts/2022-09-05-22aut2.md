...
\begin{equation}
\frac{\langle E^2 \rangle / 8 \pi}{n m v_{th}^2} = \frac{1}{16 \pi} \text{Log} \(\frac{1 + x^2}{1+(2 x / N_x)^2}\) \frac{1}{n \lambda_D^2}
\end{equation}

where $x =  \pi \lambda_D / \Delta x$ is the debye ratio (times $\pi$). 
...
The reason I compare thse two formulas is that they have the same functional form for $x \gg 1$ and $x \ll 1$
