...
\begin{equation}
\frac{\langle E^2 \rangle / 8 \pi}{n m v_{th}^2} = \frac{1}{16 \pi} \text{Log} \(\frac{1 + (\pi x)^2}{1+(2 \pi x / N_x)^2}\) \frac{1}{n \lambda_D^2}
\end{equation}

where $x = \lambda_D / \Delta x$ is the debye ratio. 
...
The reason I compare thse two formulas is that they have the same limits for $x \gg 1$ and $x \ll 1$. 
