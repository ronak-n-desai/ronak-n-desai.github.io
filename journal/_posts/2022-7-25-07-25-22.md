...
The Density comparison tests look similar to the PPC tests, except, we see that higher densities experience more heating. 
...
The one simulation with 10eV and 5nm looks very pecular though. This is re
