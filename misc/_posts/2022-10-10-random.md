...
<form id="calc" oninput="calcheight()">
  ...
  <label for="output1"><strong>Calculated Height (cm)</strong>:</label><span class="output" id="output1"></span> 
  <label for="output2"><strong>Total Energy Conservation Height (cm)</strong>:</label><p class="output" id="output2" style="display:inline"></p>
  <label for="output3"><strong>Other Height (cm)</strong>:</label><p class="output" id="output3"></p>
</form>
